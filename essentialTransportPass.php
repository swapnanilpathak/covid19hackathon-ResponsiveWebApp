...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">
      <small>Essential Services Transport Pass</small>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <h2>Essential services transport pass</h2>
...
<option value="West Karbi Anglong">West Karbi Anglong</option>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="city" name="f_vregdno" type="text" placeholder="Vehicle Registration Number" class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="city" name="f_fromd" type="date" placeholder="From date" class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="city" name="f_tod" type="date" placeholder="To date" class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="city" name="f_destination" type="text" placeholder="Destination Address" class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <?php 
              ...
              $querySubmitsByUser = $con->prepare("SELECT * FROM essentialpass WHERE userid = :id");
  ...
  <script src="assets/js/addEssentialPass.js"></script>
</body>
