...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">
      <small>Hospital Admission</small>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <p>Please fill the accompanying form for hospital admission </p>
      </div>
      <div class="col-lg-6">
        <!--form-->
          <form class="form-horizontal hospitalAdmissions" id="form">
            <input type="hidden" name="f_id" value="<?php echo $userDetails['user_id']?>">
                ...
                <div class="control-group">
                    <label class="control-label">Patient's Full Name*</label>
                    <div class="controls">
                        <input id="full-name" name="f_fullname" type="text" placeholder="patient's full name"
                        class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Patient's age*</label>
                    <div class="controls">
                        <input id="full-name" name="f_age" type="text" placeholder="patient's age "
                        class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Patient's Gender*</label>
...
<?php require_once("districtList.php");?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="city" name="f_kinname" type="text" placeholder="Your skills" class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="city" name="f_admdate" type="date" placeholder="From date" class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <?php 
              ...
              $querySubmitsByUser = $con->prepare("SELECT * FROM hospitaladmissions WHERE userid = :id");
...
<?php require_once("footer.php") ?>
  ...
  <script src="assets/js/addHospitalAdmission.js"></script>
</body>
