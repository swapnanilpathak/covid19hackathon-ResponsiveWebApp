    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-white" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="tfn.php">Toll Free Numbers</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="d.php">Donate</a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
              <a class="dropdown-item" href="userUpdateProfile.php">Update Profile</a>
              <a class="dropdown-item" href="userChangePassword.php">Change Passsword</a>
